...
def main():
    ...
    obj = ObjLoader()
    obj.load_model("data/monkey_smooth.obj")

    texture_offset = len(obj.vertex_index)*12
    normal_offset = (texture_offset + len(obj.texture_index)*8)

    shader = ShaderLoader.compile_shader("shaders/light_vert.vs", "shaders/light_frag.fs")
    ...
    # load image
    image = Image.open("data/monkey_texture.jpg")
