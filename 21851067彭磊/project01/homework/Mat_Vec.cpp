...
//	ans.unitMat();
//
//	ans.element[4 * 0 + 0] = cameraRight.x;
//	ans.element[4 * 1 + 0] = cameraRight.y;
//	ans.element[4 * 2 + 0] = cameraRight.z;
//
//	ans.element[4 * 0 + 1] = cameraUp.x;
//	ans.element[4 * 1 + 1] = cameraUp.y;
//	ans.element[4 * 2 + 1] = cameraUp.z;
//
//	ans.element[4 * 0 + 2] = cameraDirection.x;
//	ans.element[4 * 1 + 2] = cameraDirection.y;
//	ans.element[4 * 2 + 2] = cameraDirection.z;
//	
//	vec3 dot = cameraRight * cameraPosition;
//	ans.element[4 * 3 + 0] = -(dot.x + dot.y + dot.z);
//	dot = cameraUp * cameraPosition;
//	ans.element[4 * 3 + 1] = -(dot.x + dot.y + dot.z);
//	dot = cameraDirection * cameraPosition;
//	ans.element[4 * 3 + 2] = -(dot.x + dot.y + dot.z);
//	return ans;
//}