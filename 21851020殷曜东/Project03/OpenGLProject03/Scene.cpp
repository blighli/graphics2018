...
CEnvironment::CEnvironment()
{
	...
	LoadT8("data/white.bmp", g_cactus[0]);
...
//==========================================================================
bool CEnvironment::LoadT8(const char *filename, GLuint &texture)
{
...
void CEnvironment::LoadT16(const char *filename, GLuint &texture)
{
	glGenTextures(1, &texture);
	glBindTexture(GL_TEXTURE_2D, texture);
