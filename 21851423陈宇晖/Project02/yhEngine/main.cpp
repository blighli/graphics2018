...
int main()
{
	...
	// ------------------------------------
	Shader sunShader("sunshader.vert", "sunshader.frag");
	Shader earthShader("earthshader.vert", "earthshader.frag");
	...
	//Generate Texture
	//---------------------------------------------------
	unsigned int sunTexture = loadTexture("texture\\sun.jpg");
	unsigned int earthDiffuse = loadTexture("texture\\earth.jpg");
	unsigned int moonDiffuse = loadTexture("texture\\moon.jpg");
