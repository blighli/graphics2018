...
void Display(void)
{
	...
	//GLfloat sun_emission[] = { 0.6f,0.0f,0.0f,1.0f };//太阳漫反射光照

	GLfloat earth_emission[] = { 0.4f,0.4f,0.8f,50.0f };//地球漫反射光照

	GLfloat moon_emission[] = { 0.98f,0.625f,0.12f,1.0f };//月亮漫反射光照

	GLfloat sun_ambient[] = { 1.0f, 1.0f, 1.0f, 0.0f };//太阳环境光照
	...
	gltDrawSphere(12.0f, 30, 30);//绘制太阳
