...
int main() {
    ...
    Shader pointLightShader("Shaders/pointLightVertex.shader", "Shaders/pointLightFragment.shader");
    //
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, glm::radians(sunRotate), glm::vec3(0.0f, 0.0f, 1.0f));
        ...
        glUniformMatrix4fv(glGetUniformLocation(simpleShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        earthModel.Draw(pointLightShader);
        ...
        glUniformMatrix4fv(glGetUniformLocation(simpleShader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        moonModel.Draw(pointLightShader);
